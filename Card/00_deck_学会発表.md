...
- 空間性の多義性と分断 研究者ごとに「空間」や「ローカル」を異なる意味で用いるため、科学の地理学内部で概念的分断が生じている。これが理論の統合や比較研究を難しくしている。
- 「ローカル」から「流通」への説明ギャップ ローカルで成立した知識がどのように他の文脈へ移動・普及するか（地域化 vs 空間化）のメカニズムが未解明であり、知識の流通に関する理論的説明が不足している。
- 方法論的偏りと未活用の資源 実験室民族誌やエスノメソドロジー、アクター・ネットワーク理論（ANT）など有力な方法論がある一方で、地理学側からの実証的な関与（特に実験室民族誌への地理学的解釈）はまだ限定的である。
- 理論の固定化と地理的偏り ANTなどの理論が固定化され、理論的多様性や地域差を見落とす危険があること、また特定地域（例：フランスや英語圏）での偏った受容がある点が批判されている。
- 規範的・ポストコロニアル課題の未解決 先住民知識やポストコロニアルな視点をどう組み込むか、科学の公共性や専門知識の正当化に関する規範的議論が今後の重要課題である。
