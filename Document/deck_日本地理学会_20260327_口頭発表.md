...
- 科学がおこなわれる場所というのは**問題にならない**→修正！！
- 科学というのは**場所に左右されない**普遍的な営み

⇒科学の地理学はこうした見方に対して疑義を呈する

### 科学の地理学の前提

- 科学は様々な場所でおこなわれ、**場所は問題となる**→修正！！！
- 科学は場所に左右された**局地的な営み**
...
邸宅では紳士的振舞い（嘘をつかない、合理的な議論ができる）が求められていた
↓
知識の信頼性への保証につながる
...
- サイエンス・スタディーズにおける代表的な著作を基に、科学や知識と場所の関係の問題を検討したもの（リヴィングストン 2014：242、Meusburger et.al. 2010：x）。
...
### Livingstoneが提唱した科学の地理学の特徴→修正！！

- **歴史地理学の性格が強い**
  - 本人が歴史地理学の研究者である
  - SSKの代表的な研究者Steven Shapinとの交流
  - 実際に影響を受けたことを示唆している（リヴィングストン 2014）
...
- 論文「**Geographies of Science :histories, localities, practices, futures**」
  - 科学知識そのものだけでなく、
**知識がどのように現場で作られるかという科学実践も重視すべきだと指摘**
  - **歴史地理学的なアプローチへの偏りを批判**
...
Donovan and Oppenheimer（2015）は、カリブ海にあるモントセラト火山観測所における科学実践の実態を分析した。主に**火山観測所の職員と協力関係にある大学教員などを対象にインタビュー調査をおこなった**。
